...
const Signup = () => {
    ...
    const test = () => {
        cookie.set('test-cookie', 'ir3n48b3pnvut9v8t49bv4tnopn89t49n!!!')
  ...
  return (
   <div>
       <h1 className="mt-20 ml-20">Welcome!</h1>
       <form className="w-3/6 px-4 py-3 border-2 border-slate-300 rounded-md mx-auto my-auto">
            <label>Name</label>
